 ...
 *  # net use "\\computername\Receipt Printer" /site:Guest
 *  # net use "\\computername\Receipt Printer" /site:Bob secret
 *  # net use "\\computername\Receipt Printer" /site:workgroup\Bob secret
